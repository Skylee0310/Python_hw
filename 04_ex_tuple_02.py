...
#myData[0] = 'Ten' #튜플의 2번째 요소 변경 => 미지원
myData[2][0] = 'Park' #튜플 안에 있지만 리스트로 접근했기 때문에 변경 가능.
print(f'myData : {myData}')

#myData[3][0]  #튜플 안에 있음 + 튜플 자료형이기 때문에 변경이 불가하다.
